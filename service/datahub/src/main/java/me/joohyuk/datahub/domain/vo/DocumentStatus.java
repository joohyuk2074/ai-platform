...
public enum DocumentStatus {
  ...
  TRANSFORM_COMPENSATING,  // Transform+Load 보상 중: 롤백 처리 진행 중 (Saga COMPENSATING)
  TRANSFORM_COMPENSATED,   // Transform+Load 보상 완료: 롤백 완료 (Saga COMPENSATED, terminal)
  ...
  EMBED_COMPENSATING,      // Embed 보상 중: 롤백 처리 진행 중 (Saga COMPENSATING)
  EMBED_COMPENSATED,       // Embed 보상 완료: 롤백 완료 (Saga COMPENSATED, terminal)
}
