...
public class KafkaConsumerConfig {
  ...
  @Value("${spring.kafka.consumer.properties.spring.json.trusted.packages:me.joohyuk.datarex.domain.entity,me.joohyuk.messaging.events}")
  ...
  public ConsumerFactory<String, Object> consumerFactory() {
    ...
    // datarex의 메시지 모델을 수신하기 위해 me.joohyuk.datarex.domain.entity 패키지 신뢰
   ...
   *
   * <p>Consumer group이 삭제되면 auto-offset-reset: earliest 설정에 의해
   * 처음부터 메시지를 읽게 됩니다.
   */
  @Bean
