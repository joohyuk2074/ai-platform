...
/**
 * Spring AI의 TokenTextSplitter를 사용하는 DocumentTransformer 구현체 도메인 모델 DocumentContent와 Spring AI
 * Document 간 변환을 처리
 */
@Slf4j
@Component
public class SpringAiDocumentTransformer implements DocumentTransformer {
  ...
  public List<DocumentContent> transform(List<DocumentContent> documents, ChunkingConfig config) {
    ...
    try {
      ...
      throw new DatarexDomainException("문서 청킹 중 오류가 발생했습니다", DatarexErrorCode.CHUNKING_FAILED, e);
    }
  }
